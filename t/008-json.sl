...
; Round-trip test
(defvar original (list 1 2 3 4 5))
(defun json-str (json/stringify original))
(defun parsed (json/parse json-str))
...
; Nested arrays
(defvar nested (list (list 1 2) (list 3 4)))
(defun nested-json (json/stringify nested))
(defun nested-parsed (json/parse nested-json))
...
; Mixed type array
(defvar mixed (list 1 "two" true))
(defun mixed-json (json/stringify mixed))
(defun mixed-parsed (json/parse mixed-json))
